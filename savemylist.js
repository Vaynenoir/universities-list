...
function loadData(selectedRows, text, cb) {
    ...
    getJSON('https://raw.githubusercontent.com/vargi/university-domains-list/master/world_universities_and_domains.json',
        function(err, data) {
        	console.log(data);
            ...
            const filtered = data.filter((d, i) => text.toLowerCase() == d.country.toLowerCase());
